...
> [!NOTE]
> The Web API feature is only supported in model-driven apps.
...
1. From your source directory, create a directory named **TS-Web-API**.
...
1. Expand the **TSWebAPI** folder and open the **ControlManifest.Input.xml** file.
...
1. Above the constructor method, insert the following private variables to support the rendering of your component.
...
1. Add the following private static variables above the **constructor** to indicate which entity/fields you're interfacing with in this example. If you want to try against different tables or columns, you can do so by changing their respective values.
...
1. Add the following helper methods to render the HTML elements in your component after the destroy method.
...
1. Add the following onClick event handlers to trigger the various CRUD operations after the helper methods.
...
1. Add the following helper methods to render the results of your CRUD operations within your component after the event handler methods.
...
1. Create a new **TS_WebAPI.css** file inside the CSS subfolder.

1. Add the following style content to the TS_WebAPI.css file:
...
To test the web API functionality, you must publish and host the component in a Microsoft Power Platform environment. For more information on how to publish code components, see "Create a code component solution package" in the **Build a Power Apps component** module.

For more information, see [Implementing Web API component](/power-apps/developer/component-framework/sample-controls/webapi-control/?azure-portal=true).
