...
opens Power Apps has to query that data from Microsoft Entra ID directly. This
...
having to go back to Microsoft Entra ID on every screen, Power Apps can reference the
