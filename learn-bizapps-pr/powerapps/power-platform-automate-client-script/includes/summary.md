Even experienced JavaScript developers must become familiar with the scripting techniques specific to model-driven apps. This module covered more advanced topics like:
