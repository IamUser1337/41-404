In this unit, you explore the **Customize report theme** showcase. This showcase demonstrates how to use the client APIs to allow users the ability to choose the report theme and background mode.
